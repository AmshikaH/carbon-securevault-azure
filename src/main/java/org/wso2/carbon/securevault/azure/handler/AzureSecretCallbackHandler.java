...
public class AzureSecretCallbackHandler extends AbstractSecretCallbackHandler {
    ...
    protected void handleSingleSecretCallback(SingleSecretCallback singleSecretCallback) {
        ...
        /* The SingleSecretCallback object passed as an argument would have an id which specifies whether
        this method is being called to set the private key password or the keystore password as the
        SingleSecretCallback's secret value. If the id has the value "identity.dot.key.password", it means
        the secret callback is for the private key password, so the private key password is set as the secret value.
        If the id is not "identity.dot.key.password", it means the secret callback is for the keystore password
        and therefore the keystore password is set as the secret value.*/
